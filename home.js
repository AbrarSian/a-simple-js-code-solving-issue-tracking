const loadAllIssues = async () => {
 ...
 const displayAllIssues = (data) => {
    ...
    data.forEach(d => {
        ...
        issueContainer.innerHTML += `
                    <div id="card" class="rounded-lg w-[260px] shadow-2xl border border-gray-50 border-t-6 ${brColor}" >
                <div class="space-y-3 p-4">
                    ...
                    <div class="space-y-3 h-[110px]">
                        ...
                        <div class="space-x-1 h-6">
                            <button  class="border border-red-600 text-red-600 bg-red-100 px-1 w-20 rounded-4xl">Bug</button>
                            <button  class= " border border-yellow-600 text-red-400 bg-yellow-200 px-1 font-medium rounded-4xl">Help Wanted</button>
                        </div>
                    </div>
                </div>
